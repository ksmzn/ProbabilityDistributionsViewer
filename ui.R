...
# 連続分布 ----
## Normal
board.norm <- distTab(norm)
board.erlang <- distTab(erlang)
board.f <- distTab(f)
board.ncf <- distTab(ncf)
board.chisq <- distTab(chisq)
board.ncChisq <- distTab(ncChisq)
board.gamma <- distTab(gamma)
board.cauchy <- distTab(cauchy)
board.exp_dist <- distTab(exp_dist)
board.lnormal <- distTab(lnormal)
board.t_dist <- distTab(t_dist)
board.nct <- distTab(nct)
board.beta <- distTab(beta)
board.ncbeta <- distTab(ncbeta)
board.unif <- distTab(unif)
board.logis <- distTab(logis)
board.weibull <- distTab(weibull)
# 離散分布
board.geom <- distTab(geom)
board.hyper <- distTab(hyper)
board.binom <- distTab(binom)
board.nbinom <- distTab(nbinom)
board.pois <- distTab(pois)
board.dunif <- distTab(dunif)
